...
void UserInterface::initShaders()
{
	buildFX();
	buildVertexLayouts();
}
...
void UserInterface::init(float Scale, D3DXVECTOR3 Movement )
{
	void* vpDevice;
	...
	HR(D3DX10CreateShaderResourceViewFromFile(md3dDevice, 
		L"Resources/Textures/jakeLife.png", 0, 0, &mDiffuseMapRV, 0 ));
...
void UserInterface::buildFX()
{
	...
	CLogManager::GetInstance().LogEvent("Built user interface shaders");
}

void UserInterface::buildVertexLayouts()
{
