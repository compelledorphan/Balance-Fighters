...
//						
// File Name	: d3dUtil.h
// Description	: Utility functions and constants for DirectX10
// Author		: Frank Luna
// Copyright to Frank Luna (C) 2008 All Rights Reserved
//
// This file is unconventional in its layout, because the standard doesn't have a layout for it
// As it is someone elses file, variable names have not been touched, preserving copyright if applicable.
